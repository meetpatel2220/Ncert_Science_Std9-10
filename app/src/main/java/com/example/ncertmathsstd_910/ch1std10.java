...
public class ch1std10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ch1std10);
        ...
        b2a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b2d.setBackgroundColor(getColor(R.color.tru));
                b2=1;
        ...
        b3a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b3b.setBackgroundColor(getColor(R.color.tru));
                b3c.setBackground(getDrawable(R.drawable.back5));
        ...
        b3c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                b3a.setBackground(getDrawable(R.drawable.back5));
                b3b.setBackgroundColor(getColor(R.color.tru));
                b3c.setBackgroundColor(getColor(R.color.fals));
                b3d.setBackground(getDrawable(R.drawable.back5));
                b3=1;
        ...
        b4a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(b4==0){
                    b4a.setBackgroundColor(getColor(R.color.tru));
        ...
        b5a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b5d.setBackgroundColor(getColor(R.color.tru));
                b5=1;
        ...
        b6a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b6d.setBackgroundColor(getColor(R.color.tru));
                b6=1;
        ...
        b7a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b7b.setBackgroundColor(getColor(R.color.tru));
        ...
        b9a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b9b.setBackground(getDrawable(R.drawable.back5));
                b9c.setBackgroundColor(getColor(R.color.tru));
        ...
        b9b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b9b.setBackgroundColor(getColor(R.color.fals));
                b9c.setBackgroundColor(getColor(R.color.tru));
                b9d.setBackground(getDrawable(R.drawable.back5));
                b9=1;
        ...
        b10b.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                b10a.setBackground(getDrawable(R.drawable.back5));
